 ...
 */
  ...
  $existeFicheFrais = $pdo->getLesInfosFicheFrais(obtenirIdUserConnecte(), $mois);
  // si elle n'existe pas, on la crée avec les élets frais forfaitisés à 0
  if ( !$existeFicheFrais ) {
      $pdo->creeNouvellesLignesFrais(obtenirIdUserConnecte(),$mois);
  }
  ...
  if ($etape == "validerSaisie") { 
      ...
      if (!$ok) {
          ...
          $pdo->majFraisForfait(obtenirIdUserConnecte(),$mois,$tabQteEltsForfait);
      }
  }                                                       
  ...
  elseif ($etape == "validerAjoutLigneHF") {
      ...
      if ( nbErreurs($tabErreurs) == 0 ) {
          ...
          $pdo->creeNouveauFraisHorsForfait(obtenirIdUserConnecte(),$mois,$libelleHF,$dateHF,$montantHF);
      }
  }
